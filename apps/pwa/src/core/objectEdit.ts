...
export function mirrorHorizontal(obj: Obj): Partial<Obj> | null {
  ...
  if (obj.kind === "macro") {
    if (obj.defId === "mount-hole" || obj.defId === "button") {
      return { transform: { ...obj.transform, e: 2 * cx - obj.transform.e } };
    }
...
export function mirrorVertical(obj: Obj): Partial<Obj> | null {
  ...
  if (obj.kind === "macro") {
    if (obj.defId === "mount-hole" || obj.defId === "button") {
      return { transform: { ...obj.transform, f: 2 * cy - obj.transform.f } };
    }
...
export function rotate90(obj: Obj, dir: 1 | -1 = 1): Partial<Obj> | null {
  ...
  if (obj.kind === "macro") {
    if (obj.defId === "mount-hole" || obj.defId === "button") {
      return { transform: { ...obj.transform, e: cx, f: cy } };
    }
    if (obj.defId === "panel" || obj.defId === "screen") {
      return {
        transform: { ...obj.transform, e: newMinX, f: newMinY },
  ...
  if (obj.kind === "path") {
    const t = obj.transform;
    // Rotate transform 90° around (cx, cy). Y-down CW: (dx,dy) -> (dy, -dx)
    if (dir === 1) {
      return {
        transform: {
          a: t.c,
...
export function duplicateObject(obj: Obj, offsetMm = 10): Obj {
  ...
  copy.transform = {
    ...copy.transform,
    e: copy.transform.e + offsetMm,
    f: copy.transform.f + offsetMm
  };
  return copy;
}
