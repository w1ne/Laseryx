...
export type EnclosureValidationIssue = { code: "invalid-dimension" | "impossible-slope" | "edge-too-short" | "joint-geometry-infeasible" | "source-panel-invalid" | "cutout-joint-collision"; message: string; field?: string; edgeIds?: [string, string]; componentIds?: string[]; causeCode?: string };
