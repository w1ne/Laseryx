...
export type EnclosurePanel = { id: "front" | "rear" | "left" | "right" | "base" | "service-lid"; name: string; width: number; height: number; paths: PolylinePath[]; transform: Transform; removable?: boolean; fingerCount: number };
