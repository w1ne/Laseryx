...
export function ComponentEditor({ onSave, onCancel }: ComponentEditorProps) {
  ...
  return <div className="components-box__editor" role="group" aria-label="Component editor">
    ...
    <div className="components-box__editor-actions"><button type="button" onClick={save}>Save component</button><button type="button" onClick={onCancel}>Cancel</button></div>
  </div>;
}
